...
**Backend:** 2644 tests, of which 937 are security-regression locks (`@pytest.mark.security`). **Frontend:** 293 tests across security and functional trees. A security-tree failure is a release blocker.
